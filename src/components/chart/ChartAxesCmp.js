...
var ChartAxesCmp = (function () {
    ...
    ChartAxesCmp = __decorate([
        ...
        core_1.View({
            ...
            directives: [wijmo_angular2_all_1.wjNg2Chart.WjFlexChart, wijmo_angular2_all_1.wjNg2Chart.WjFlexChartSeries, wijmo_angular2_all_1.wjNg2Chart.WjFlexChartAxis,
                wijmo_angular2_all_1.wjNg2Input.WjMenu, wijmo_angular2_all_1.wjNg2Input.WjMenuItem, common_1.CORE_DIRECTIVES]
        })
    ], ChartAxesCmp);
    return ChartAxesCmp;
})();
