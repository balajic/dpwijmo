...
var GridTemplatesCmp = (function (_super) {
    ...
    GridTemplatesCmp = __decorate([
        ...
        core_1.View({
            ...
            directives: [wijmo_angular2_all_1.wjNg2Grid.WjFlexGrid, wijmo_angular2_all_1.wjNg2Grid.WjFlexGridColumn, wijmo_angular2_all_1.wjNg2Grid.WjFlexGridCellTemplate, common_1.CORE_DIRECTIVES,
                wijmo_angular2_all_1.wjNg2Input.WjInputNumber],
        }),
